...
class UsuarioController extends CI_Controller
{
    ...
    public function entrar()
    {
        ...
        $usuario = $this->usuariomodel->procurar_usuario($dados)[0];
        $usuario->cidade = $this->usuariomodel->cidade_usuario($usuario->cidade);        
    ...
    {
        $data['cidades'] = $this->regioesmodel->pegar_cidades_regiao($id);
        $this->load->view('header');
    ...
    public function cadastrar()
    {
        ...
        $values['cidade'] = 93;
        $bool = $this->usuariomodel->salvar_usuario($values);
